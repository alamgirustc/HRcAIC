...
__C.DATA_LOADER.GEO_FEATS_FOLDER = 'gdata/Alamgir/mscoco/feature/cnn_feats/geo_feats'  # Updated path
...
__C.INFERENCE.COCO_PATH = '/ghome/Alamgir/CNN30/coco_caption'
...
__C.SEED = -1.0
__C.TEMP_DIR = '/ghome/Alamgir/CNN30/data/temp'
